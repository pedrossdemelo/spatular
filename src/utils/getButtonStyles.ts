  ...
  switch (variant) {
    case "outlined":
      switch (color) {
        ...
        case "secondary":
          return {
            text: tw`text-stone-800 dark:text-neutral-100`,
            outer: tw`border border-stone-800 dark:border-neutral-100`,
            press: tw`text-stone-800/20 dark:text-neutral-100/20`
              .color as string,
          };
      }
    case "contained":
      switch (color) {
        ...
        case "secondary":
          return {
            text: tw`text-stone-100 dark:text-neutral-800`,
            inner: tw`bg-stone-800 dark:bg-stoneneutral100`,
            press: tw`text-stone-100/20 dark:text-neutral-800/20`
              .color as string,
          };
      }
    case "text":
